<!-- Reproduced verbatim from https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/3fcbb9f/okf/SPEC.md
     (OKF v0.2, upstream commit 3fcbb9f, 2026-07-24).
     Copyright Google LLC, licensed under the Apache License 2.0 (see LICENSE in this repo).
     The URL is pinned to a commit because upstream main moves; do not repoint it at main. -->
