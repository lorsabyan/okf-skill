<!-- Reproduced verbatim from https://github.com/GoogleCloudPlatform/open-knowledge-format/blob/ad30107/SPEC.md
     (OKF v0.2, upstream commit ad30107, 2026-08-21). OKF moved to its own repository;
     the okf/ copy in GoogleCloudPlatform/knowledge-catalog is a frozen, unmaintained snapshot.
     Copyright Google LLC, Apache 2.0 (see LICENSE). Pinned to a commit; do not repoint it at main. -->
